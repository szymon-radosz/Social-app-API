                ...
                <div class="row">
                    <div class="col-xs-12 col-md-10 col-md-offset-1">
                        <div class="page-title text-center">
                            ...
                            <div class="space-20"></div>
                            <p>Resetowanie hasła zakończone sukcesem. Zaloguj się do aplikacji E-mamy. Podziel się z nami swoimi spostrzeżeniami wysyłając wiadomość pod adres <a href="mailto:kontakt@e-mamy.pl" title="Napisz wiadomość">kontakt@e-mamy.pl</a></p>
                        </div>
                    </div>
                </div>
            </div>
